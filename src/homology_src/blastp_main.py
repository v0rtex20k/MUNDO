...
if __name__ == '__main__':
	...
	parser.add_argument("-q", "--query_coverage", help="query coverage threshold (0-100)", type=float, nargs='?', default=0.0)
	parser.add_argument("-p", "--percent_id", help="percent ID threshold (0-100)", type=float, nargs='?', default=0.0)
	...
	for n in ['1','1+','2','2+','3','3+']:
		print(f'\tStarting strawman {n}...')
		args['strawman_number'] = n
		blastp.core(args)