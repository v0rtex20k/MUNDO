...
if __name__ == '__main__':
	...
	supported_organisms = ['HUMAN', 'DROME', 'MOUSE', 'RAT', 'ARATH', 'CHICK', 'DICTY', 'CANLF', 'PIG', 'CAEEL', 'YEAST', 'SCHPO']
	supported_databases = ['BIOGRID', 'BIOPLEX', 'DIP', 'GENEMANIA', 'GIANT', 'HUMANNET', 'LEGACY_BIOGRID','REACTOME', 'STRING']
	...
	parser.add_argument("-j", "--job_id", help="name of directory where BLASTP files should be saved.", type=str, default='./')
